<template>
                    ...
                    <tr v-for="supplier in paginatedSuppliers" :key="supplier.id">
                      ...
                      <td class="text-center" style="white-space:nowrap;">
                        <div class="d-flex gap-1 justify-content-center">
                          <button class="btn btn-sm btn-outline-info rounded-3 px-2" @click="openViewModal(supplier)" title="Ver detalle">
                            <i class="fa-solid fa-eye"></i>
                          </button>
                          <button class="btn btn-sm btn-outline-warning rounded-3 px-2" @click="openEditModal(supplier)" title="Editar proveedor">
                          ...
                          <button
                            ...
                            :title="supplier.dependencies_count > 0 ? 'No se puede eliminar: tiene dependencias' : 'Eliminar proveedor'"
                          >
  ...
  <div class="modal fade" id="supplierFormModal" tabindex="-1" aria-labelledby="supplierFormModalLabel" aria-hidden="true" ref="formModalRef">
