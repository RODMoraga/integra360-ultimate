<template>
  ...
  <!-- Form Modal -->
  <div class="modal fade" id="supplierContactFormModal" tabindex="-1" aria-labelledby="supplierContactFormModalLabel" aria-hidden="true" ref="formModalRef">
...
.contact-form-tab-content::-webkit-scrollbar-track {
  background: #f1f1f1;
  border-radius: 10px;
}

.contact-form-tab-content::-webkit-scrollbar-thumb {
  background: #cbd5e1;
  border-radius: 10px;
}
</style>
