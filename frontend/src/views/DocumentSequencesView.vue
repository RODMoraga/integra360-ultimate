<template>
  ...
  <div :class="['modal fade', isEditMode ? 'modal-variant-edit' : 'modal-variant-create']" id="documentSequenceFormModal" tabindex="-1" aria-labelledby="documentSequenceFormModalLabel" aria-hidden="true" ref="formModalRef">
