<template>
  ...
  <div class="modal fade" id="documentTypeFormModal" tabindex="-1" aria-labelledby="documentTypeFormModalLabel" aria-hidden="true" ref="formModalRef">
...
const buildActionButtons = (item: DocumentTypeItem) => {
  ...
  return `
    <div class="d-flex gap-1 justify-content-center">
      ...
      <button type="button" class="btn btn-sm btn-outline-warning rounded-3 px-2" data-action="edit" data-id="${item.id}" title="Editar tipo">
