<template>
                    ...
                    <tr v-for="model in paginatedModels" :key="model.id">
                      ...
                      <td class="text-center" style="white-space:nowrap;">
                        <div class="d-flex gap-1 justify-content-center">
                          <button class="btn btn-sm btn-outline-info rounded-3 px-2" @click="openViewModal(model)" title="Ver detalle">
                            <i class="fa-solid fa-eye"></i>
                          </button>
                          <button class="btn btn-sm btn-outline-warning rounded-3 px-2" @click="openEditModal(model)" title="Editar modelo">
                          ...
                          <button
                            ...
                            :title="model.dependencies_count > 0 ? 'No se puede eliminar: tiene dependencias' : 'Eliminar modelo'"
                          >
  ...
  <div class="modal fade" id="modelFormModal" tabindex="-1" aria-labelledby="modelFormModalLabel" aria-hidden="true" ref="formModalRef">
